...
// extern int Frequency_Table_Big[BIG_FREQ_SIZE+1];
...
extern double VDD_B[BIG_FREQ_SIZE+1];

// extern int Frequency_Table_Little[LITTLE_FREQ_SIZE+1];
...
extern double VDD_L[LITTLE_FREQ_SIZE+1];
